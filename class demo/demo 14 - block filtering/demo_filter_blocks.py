...
# Incorrect version - blocking artifacts
...
wavfile = "/Users/jinchengbaby/Desktop/jincheng Tian tandon second semester/dsp/class demo/demo 14 - block filtering/author.wav"
output_wavfile = 'author_output_blocks.wav'
...
# Get first set of frames from wave file
...
while len(binary_data) == WIDTH * BLOCKLEN:
    ...
    # filter
    output_block = scipy.signal.lfilter(b, a, input_block)  # Like 'filter' in Matlab
